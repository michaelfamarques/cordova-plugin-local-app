...
class LocalApp {
    ...
    checkNewVersionExists() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.currentLocalVersion && (0, semver_1.gt)(this.currentLocalVersion, this.params.currentVersion)) {
            ...
            try {
                ...
                if ((0, semver_1.gt)(lastVersion.version, localVersion)) {
                    yield this.installVersion(lastVersion, false);
                    localVersion = lastVersion.version;
                    isLocalInstaled = true;
                }
                else if ((0, semver_1.gt)(lastVersion.version, localVersion) && lastVersion.build > localBuildNumber) {
